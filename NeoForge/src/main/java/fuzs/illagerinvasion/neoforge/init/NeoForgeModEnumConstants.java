...
public class NeoForgeModEnumConstants {
    public static final EnumProxy<Raid.RaiderType> BASHER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.BASHER,
            RaidWavesConfigHelper.BASHER_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> PROVOKER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.PROVOKER,
            RaidWavesConfigHelper.PROVOKER_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> NECROMANCER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.NECROMANCER,
            RaidWavesConfigHelper.NECROMANCER_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> SORCERER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.SORCERER,
    ...
    public static final EnumProxy<Raid.RaiderType> ARCHIVIST_RAIDER_TYPE = registerRaiderType(ModEntityTypes.ARCHIVIST,
            RaidWavesConfigHelper.ARCHIVIST_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> MARAUDER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.MARAUDER,
            RaidWavesConfigHelper.MARAUDER_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> INQUISITOR_RAIDER_TYPE = registerRaiderType(ModEntityTypes.INQUISITOR,
            RaidWavesConfigHelper.INQUISITOR_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> ALCHEMIST_RAIDER_TYPE = registerRaiderType(ModEntityTypes.ALCHEMIST,
            RaidWavesConfigHelper.ALCHEMIST_RAID_WAVES);
    public static final EnumProxy<Raid.RaiderType> INVOKER_RAIDER_TYPE = registerRaiderType(ModEntityTypes.INVOKER,
