...
public class ModEntityLootProvider extends AbstractLootProvider.EntityTypes {
    ...
    public void addLootTables() {
        ...
        this.add(ModEntityTypes.ALCHEMIST.value(),
                illagerTable(context).withPool(LootPool.lootPool()
                ...
                illagerTable(context).withPool(LootPool.lootPool()
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(Items.PAPER)
                                        ...
                                        .apply(EnchantedCountIncreaseFunction.lootingMultiplier(context,
                                                UniformGenerator.between(0.0F, 1.0F))))));
        this.add(ModEntityTypes.BASHER.value(), illagerTable(context));
        ...
        this.add(ModEntityTypes.MARAUDER.value(),
                platinumTable(context).withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1.0F))
                        .add(LootItem.lootTableItem(Items.OMINOUS_BOTTLE)
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                                .apply(SetOminousBottleAmplifierFunction.setAmplifier(UniformGenerator.between(0.0F,
                                        4.0F))))
                        .when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS,
                                EntityPredicate.Builder.entity().raider(RaiderPredicate.CAPTAIN_WITHOUT_RAID)))));
    ...
    public static LootTable.Builder illagerTable(HolderLookup.Provider context) {
        return platinumTable(context).withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(LootItem.lootTableItem(Items.EMERALD)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 1.0F)))
                        .apply(EnchantedCountIncreaseFunction.lootingMultiplier(context,
    ...
    public static LootTable.Builder platinumTable(HolderLookup.Provider context) {
        return LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool()
                        ...
                        .when(LootItemKilledByPlayerCondition.killedByPlayer())
                        .when(LootItemRandomChanceWithEnchantedBonusCondition.randomChanceAndLootingBoost(context,
                                0.11F,
                                0.02F)));
    }
}
